...
def reverse_list(head):
    ...
    if head.next == None:
        return head
    '''Recursive step '''
    reverse_head = reverse_list(head.next)
    head.next.next = head
    head.next = None
    return reverse_head
...
def palindrome_helper(head,start = None):
    '''Base case'''
    if start == None:
    ...
    '''Recursive steps'''
    compare, is_palindrome = palindrome_helper(head.next, start)
    ...
    return compare.next, is_palindrome
